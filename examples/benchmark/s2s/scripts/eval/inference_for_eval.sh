...
code_dir=/data/yanruiqi/SLAM-LLM/examples/benchmark/s2s
...
python $code_dir/inference_s2s.py \
        ...
        ++model_config.file=$code_dir/model/slam_model_s2s.py:model_factory \
        ...
        ++dataset_config.file=$code_dir/speech_dataset_s2s.py:get_speech_dataset \
