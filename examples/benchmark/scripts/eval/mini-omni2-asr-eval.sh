...
ckpt_dir=/data/ruiqi.yan/omni_models/mini-omni2-test/checkpoint
...
decode_log=/data/ruiqi.yan/omni_models/mini-omni2-test/${val_data_name}

# -m debugpy --listen 5678 --wait-for-client
python $code_dir/mini-omni2-test/inference_for_eval.py \
...
python $code_dir/evaluate.py --eval_dir /data/ruiqi.yan/omni_models/mini-omni2-test