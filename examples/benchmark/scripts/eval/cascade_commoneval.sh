...
ckpt_path=/data/ruiqi.yan/omni_models/model/gpu16-btz4-lr5e-4-fp16-epochs10-whisper_small-latency3-group5-s2s_epoch_3_step_6590
split=test
...
# decode config
text_repetition_penalty=1.21
audio_repetition_penalty=1.22        # default 1.0, set to 1.2 for reduce silence
max_new_tokens=2000                 # 500 for SNAC, 3000 for CosyVoice-single
do_sample=false
top_p=0.9
top_k=50
temperature=1.0
...
ckpt_path=/data/ruiqi.yan/omni_models/model/gpu16-btz4-lr5e-4-fp16-epochs10-whisper_small-latency5-group5-s2s_epoch_3_step_6590
split=test
